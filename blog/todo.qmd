...
| Generic cover letter             |            | I would like to use AI to generate cover letters more specific to some postings too.                                                                                            |
| Logs to socket.                  |            | I would like to have logs in the browser and to not have to keep the dev server open in the terminal.                                                                           |
...
| Beutiful soup.            |            | Make sure that links are valid.                                                                 |
