...
| --------------------------------- | --------- | --------------------------------------------------------------------- |
| Finish HTML Resume `Projects`     |           |                                                                       |
| Hovering on Floaty Title          |           | Tooltip should be shown. Or maybe animated border (Chris suggests)    |
| Finish HTML Resume `Skills`       |           | Just need to finish filling out the overlay.                          |
| Overlay exit icon                 |           | Might not be boomer proof                                             |
...
| Improve `projects/blog/index.qmd` |           | Finish overlays, round out content, make it look pretty for geusts    |
...
<script>
  Array
    ...
    .map(item => {
      ...
      completed.closest("tr").classList.add("table-success")
    })
