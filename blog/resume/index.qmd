...
- Delivered [acederberg.io](https://acederberg.io) to advertise services,
  distribute resume, host blog posts and notes, and showcase projects.
- Ensured site reliability of [acederberg.io](https://acederberg.io) and future
  web services with CI/CD and IaC.
- To support future commercial products, built [captura](https://github.com/acederberg).
