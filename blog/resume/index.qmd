...
::: { .under-construction-medium .my-5 }

Soon an enumeration of my ui/ux skills will be here.
...
Soon an enumeration of general software skills will be here.
...
Through my various projects I have developed habits conducive to
...
Data storage and retrieval is an essential part of all modern web
...
Soon an enumeration of my database and API skills will be here.
...
However, you can learn about projects by using `Projects` in the navigation bar.
