...
I want to use [bootstrap progress](https://getbootstrap.com/docs/5.3/components/progress/)
to progress indicators to the overlay.
...
::: { .education education_item="harvard" }
...
<!-- Stop Projects ---> :::
<!-- Start Projects --> :::: { #resume-experience }
