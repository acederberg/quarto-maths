...
Lead the design and implementation of building management and analytics
SaaS to empower building management teams and owners to optimize and have clear
insights into their utility usage and expenditure.
...
- Ensured confidentiality, security, and accuracy of customer data from the
  Cufflink API using `OAuth` to safeguard API endpoints, `MySQL` to make secure
...
- Improved developer efficiency and ensured software quality with automated
...
- Streamlined internal data operations and created data pipeline visibility by
