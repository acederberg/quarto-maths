...
format:
  html:
    include-in-header:
      - file: ../../includes/mermaid_setup.html
---

## {{< iconify logos linode >}} Infrastructure

The blog is deployed onto infrastructure provisioned in linode
by another project listed
here, [see the automation project](./projects/automation).

## {{< iconify logos git >}} Deployment Workflow
...
```{mermaid}
%%| fig-cap: By the way, this diagram was made possible using [`mermaid` architecture diagrams](https://mermaid.js.org/syntax/architecture.html).
