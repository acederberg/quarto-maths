...
#blog-thank-you-tools li iconify-icon,
#blog-thank-you li img {
  height: 192px;
  width: 192px;
}

#overlay iconify-icon,
#blog-thank-you li img,
#blog-thank-you-tools li iconify-icon {
  padding: 32px;
  transition: all 1s;
...
#blog-thank-you-tools li iconify-icon:hover,
#blog-thank-you li img:hover{
  transform: scale(1.1);
...
<script>
  let overlay_content_data = {
    Pulumi: `Pulumi is a great infrastructure as code tool available in most popular lanugages.`
  }
