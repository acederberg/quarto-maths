...
- [Minikube](https://minikube.sigs.k8s.io/docs/) - A cloud free solution. This
  ...
  this as it is the cheapest. _(all you need is electricity!)_
...
In my blog post about building a `docker` image you can find out how to
...
1. `traefik` and its custom resource definitions have been added to
   `kubernetes`.
2. `traefik` has a certificate resolver `letsencrypt`.
3. That your website is `example.io`.
