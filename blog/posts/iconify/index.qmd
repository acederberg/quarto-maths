...
## {{< iconify logos kubernetes >}} Use Case
...
```{.python include="../../../scripts/iconify.py"}
...
output, e.g. make a file `./includes/mermaid_setup.html` that calles `mermaid.registerIconPacks`:

```{.html include="../../includes/mermaid_setup.html" snippet="script"}
