...
links:
  - identifier: floaty-resume-links
    ...
    content:
      ...
      - key: resume-site
        title: HTML Resume
        href: https://acederberg.io/resume/index.html
        tooltip: Most recent version of my resume in ``PDF`` format.
        label: Resume
        image:
          bootstrap:
...
listing:
  - id: landing-page-posts-listing
    ...
    image-height: 320px;
    contents:
      - ./posts/neovim-queries-case-study/index.qmd
      - ./posts/logistic/index.qmd
      - ./posts/quarto-kube-static/index.qmd
  ...
  <div id=landing-page-banner>
    <div id=landing-page-banner-content>
      <div id=landing-page-banner-title>
        <!-- <div id="landing-page-banner-title-right"> -->
          <div id="acederberg-io">ACEDERBERG.IO</div>
          <!-- <h1 class="pt-5">Adrian Cederberg's Glorious Tech Imporium</h1> -->
          <!-- <h2 class="pb-5">The worlds greatest tech blog ever written, ever.</h2> -->
          <div id="landing-page-links" class="py-5">
            <div class="link-item">
            ...
            <div class="link-item">
              <a href="https://acederberg.io/resume">
      ...
      <script type="module">
        import * as asciiart  from "/js/asciiart.js"

        asciiart.forLandingPage()
      </script>
    </div>
  </div>
</header>
...
This is a blog where I post about my technical intrests and contribute articles
