...
For this demonstration we will plot a sine wave with an increasing phase 
$\phi$ over the interval $[0, \pi)$. More precisely, we are plotting

\begin{equation}
  f_\psi: \phi \mapsto sin(\phi + \psi)
\end{equation}

for consecutive $\psi \in [0, \pi)$ and all $[0, \pi]$ on each frame.
